...
# - medical_aid_premium
medical_aid_premium = float(input("med aid premium: R")) 
# - num_dependents (for medical credits)
num_dependants = (input("how many dependants on your med aid?:"))
#print(f"your gross salary is 'R'{monthly_gross_salary} while your med aid premiums are 'R'{medical_aid_premium} with {num_dependants} dependants ")
#print(f"your gross salary is R{monthly_gross_salary:.2f} while your medical aid premium is R{medical_aid_premium:.2f} with {num_dependants} dependants")
...
if uif > 177.12:
    uif = 177.12
print("Monthly UIF Contribution:", uif)
...
elif annual_gross > 383100 and annual_gross <= 531600:

    base_tax = 80078 + (annual_gross - 383100) * 0.31

elif annual_gross <= 673000:

    base_tax = 126475 + (annual_gross - 531600) * 0.36

elif annual_gross <= 857900:

    base_tax = 177147 + (annual_gross - 673000) * 0.39

elif annual_gross <= 1817000:

    base_tax = 251258 + (annual_gross - 857900) * 0.41

else:

    base_tax = 644489 + (annual_gross - 1817000) * 0.45
print("question 5: base_tax")
